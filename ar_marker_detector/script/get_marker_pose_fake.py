...
# not using the servvice call for this moment
    def getmarkerPose_cb(self,request): #Service call back
        ...
        resp.poseStamped.header.frame_id ="world"
        resp.poseStamped.header.stamp = rospy.Time()
        if (request.ar_marker_id == 1):
            resp.poseStamped.pose.position.x = 0.38
            resp.poseStamped.pose.position.y = 0.76
            resp.poseStamped.pose.position.z = 1.02
            resp.poseStamped.pose.orientation.x = -0.54
            resp.poseStamped.pose.orientation.y = 0.46
            resp.poseStamped.pose.orientation.z = 0.54
            resp.poseStamped.pose.orientation.w = 0.46
        if (request.ar_marker_id == 2):
            resp.poseStamped.pose.position.x = 0.58
            resp.poseStamped.pose.position.y = 0.76
            resp.poseStamped.pose.position.z = 1.02
            resp.poseStamped.pose.orientation.x = -0.54
            resp.poseStamped.pose.orientation.y = 0.46
