...
#include "man_behavior_tree_nodes/bt_skill_nodes/service_clients/update_param_service_client.hpp"
...
BT::NodeStatus UpdateParamServiceClient::on_success()
{
  ...
  if(param_string_.size() != 0)
  {
    ...
    // {
    //   ROS_INFO_STREAM_NAMED(service_client_name_, service_client_name_<<": String, "<< it->first << ", " << it->second<< "\n");
    // }
  ...
  if(param_float_.size() != 0)
  {
    ...
    // {
    //   ROS_INFO_STREAM_NAMED(service_client_name_, service_client_name_<<": Float, "<< it->first << ", " << it->second<< "\n");
    // }
  ...
  if(param_bool_.size() != 0)
  {
    ...
    // {
    //   ROS_INFO_STREAM_NAMED(service_client_name_, service_client_name_<<": Bool, "<< it->first << ", " << it->second<< "\n");
    // }
  ...
  if(param_int_.size() != 0)
  {
    ...
    // {
    //   ROS_INFO_STREAM_NAMED(service_client_name_, service_client_name_<<": Int, "<< it->first << ", " << it->second<< "\n");
    // }
  ...
  BT::NodeBuilder builder =
    [](const std::string & name, const BT::NodeConfiguration & config)
    {
      return std::make_unique<man_behavior_tree_nodes::UpdateParamServiceClient>(
        name, "skill_update_param", config);
    };
