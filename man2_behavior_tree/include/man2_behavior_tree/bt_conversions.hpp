...
#ifndef MAN2_BEHAVIOR_TREE__BT_CONVERSIONS_HPP_
#define MAN2_BEHAVIOR_TREE__BT_CONVERSIONS_HPP_
...
{
/**
 * @brief The following templates define how to map ros message type to paratemer defined as string used in BT xml.
 */
...
#endif  // MAN2_BEHAVIOR_TREE__BT_CONVERSIONS_HPP_
