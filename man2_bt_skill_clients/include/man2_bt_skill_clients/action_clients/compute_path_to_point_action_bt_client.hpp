...
#ifndef MAN2_BT_SKILL_CLIENTS__COMPUTE_PATH_TO_POINT_ACTION_CLIENT_HPP_
#define MAN2_BT_SKILL_CLIENTS__COMPUTE_PATH_TO_POINT_ACTION_CLIENT_HPP_
...
{
class ComputePathToPointActionClient
: public ros2_behavior_tree::BtActionClientNode<moveit_skills::action::ComputePathToPoint>
{
public:
  using Action = moveit_skills::action::ComputePathToPoint;
  using ActionResult = moveit_skills::action::ComputePathToPoint::Result;
  using ComputePathResult = moveit_skills::msg::ComputePathResult;

  ComputePathToPointActionClient(
    const std::string & xml_tag_name, const BT::NodeConfiguration & conf)
  : ros2_behavior_tree::BtActionClientNode<Action>(xml_tag_name, "compute_path_to_point", conf)
  {
  }
  ...
  static BT::PortsList providedPorts()
  {
    return providedBasicPorts({
      ...
      BT::InputPort<geometry_msgs::msg::PointStamped>(
        "target_point", "The point that move group moves to"),
...
#endif  // MAN2_BT_SKILL_CLIENTS__COMPUTE_PATH_TO_POINT_ACTION_CLIENT_HPP_
