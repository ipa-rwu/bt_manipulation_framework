...
#ifndef MAN2_BT_SKILL_CLIENTS__COMPUTE_PATH_TO_STATE_ACTION_CLIENT_HPP_
#define MAN2_BT_SKILL_CLIENTS__COMPUTE_PATH_TO_STATE_ACTION_CLIENT_HPP_

#include "man2_behavior_tree/bt_action_client_node.hpp"
#include "man2_behavior_tree/bt_conversions.hpp"
#include "moveit_msgs/msg/robot_trajectory.hpp"
#include "moveit_skills/action/compute_path_to_state.hpp"
#include "moveit_skills/msg/compute_path_result.hpp"

namespace man2_bt_skill_clients
{
class ComputePathToStateActionClient
: public ros2_behavior_tree::BtActionClientNode<moveit_skills::action::ComputePathToState>
{
public:
  using Action = moveit_skills::action::ComputePathToState;
  using ActionResult = moveit_skills::action::ComputePathToState::Result;
  using ComputePathResult = moveit_skills::msg::ComputePathResult;

  ComputePathToStateActionClient(
    const std::string & xml_tag_name, const BT::NodeConfiguration & conf)
  : ros2_behavior_tree::BtActionClientNode<Action>(xml_tag_name, "compute_path_to_state", conf)
  {
  }
  ...
  static BT::PortsList providedPorts()
  {
    return providedBasicPorts({
      ...
      BT::InputPort<std::string>("named_state", "The named state of the move group"),
...
#endif  // MAN2_BT_SKILL_CLIENTS__COMPUTE_PATH_TO_STATE_ACTION_CLIENT_HPP_
