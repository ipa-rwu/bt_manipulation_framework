...
static const std::string COMPUTE_PATH_NAME = "compute_path_skill";  // name of 'compute path skill' action
...
static const std::string UPDATE_PARAM = "update_param";  // name of 'update_param' service
